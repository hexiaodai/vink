...
// DeepCopyInto supports using DataVolumeConfig_OSFamily within kubernetes types, where deepcopy-gen is used.
func (in *DataVolumeConfig_OSFamily) DeepCopyInto(out *DataVolumeConfig_OSFamily) {
	p := proto.Clone(in).(*DataVolumeConfig_OSFamily)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DataVolumeConfig_OSFamily. Required by controller-gen.
func (in *DataVolumeConfig_OSFamily) DeepCopy() *DataVolumeConfig_OSFamily {
	if in == nil {
		return nil
	}
	out := new(DataVolumeConfig_OSFamily)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new DataVolumeConfig_OSFamily. Required by controller-gen.
func (in *DataVolumeConfig_OSFamily) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using DataVolumeConfig_OSFamily_Centos within kubernetes types, where deepcopy-gen is used.
func (in *DataVolumeConfig_OSFamily_Centos) DeepCopyInto(out *DataVolumeConfig_OSFamily_Centos) {
	p := proto.Clone(in).(*DataVolumeConfig_OSFamily_Centos)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DataVolumeConfig_OSFamily_Centos. Required by controller-gen.
func (in *DataVolumeConfig_OSFamily_Centos) DeepCopy() *DataVolumeConfig_OSFamily_Centos {
	if in == nil {
		return nil
	}
	out := new(DataVolumeConfig_OSFamily_Centos)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new DataVolumeConfig_OSFamily_Centos. Required by controller-gen.
func (in *DataVolumeConfig_OSFamily_Centos) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using DataVolumeConfig_OSFamily_Ubuntu within kubernetes types, where deepcopy-gen is used.
func (in *DataVolumeConfig_OSFamily_Ubuntu) DeepCopyInto(out *DataVolumeConfig_OSFamily_Ubuntu) {
	p := proto.Clone(in).(*DataVolumeConfig_OSFamily_Ubuntu)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DataVolumeConfig_OSFamily_Ubuntu. Required by controller-gen.
func (in *DataVolumeConfig_OSFamily_Ubuntu) DeepCopy() *DataVolumeConfig_OSFamily_Ubuntu {
	if in == nil {
		return nil
	}
	out := new(DataVolumeConfig_OSFamily_Ubuntu)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new DataVolumeConfig_OSFamily_Ubuntu. Required by controller-gen.
func (in *DataVolumeConfig_OSFamily_Ubuntu) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using DataVolumeConfig_OSFamily_Debian within kubernetes types, where deepcopy-gen is used.
func (in *DataVolumeConfig_OSFamily_Debian) DeepCopyInto(out *DataVolumeConfig_OSFamily_Debian) {
	p := proto.Clone(in).(*DataVolumeConfig_OSFamily_Debian)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DataVolumeConfig_OSFamily_Debian. Required by controller-gen.
func (in *DataVolumeConfig_OSFamily_Debian) DeepCopy() *DataVolumeConfig_OSFamily_Debian {
	if in == nil {
		return nil
	}
	out := new(DataVolumeConfig_OSFamily_Debian)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new DataVolumeConfig_OSFamily_Debian. Required by controller-gen.
func (in *DataVolumeConfig_OSFamily_Debian) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using DataVolumeConfig_OSFamily_Windows within kubernetes types, where deepcopy-gen is used.
func (in *DataVolumeConfig_OSFamily_Windows) DeepCopyInto(out *DataVolumeConfig_OSFamily_Windows) {
	p := proto.Clone(in).(*DataVolumeConfig_OSFamily_Windows)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DataVolumeConfig_OSFamily_Windows. Required by controller-gen.
func (in *DataVolumeConfig_OSFamily_Windows) DeepCopy() *DataVolumeConfig_OSFamily_Windows {
	if in == nil {
		return nil
	}
	out := new(DataVolumeConfig_OSFamily_Windows)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new DataVolumeConfig_OSFamily_Windows. Required by controller-gen.
func (in *DataVolumeConfig_OSFamily_Windows) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
