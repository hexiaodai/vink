...
func (in *VirtualMachineStatus) DeepCopyInto(out *VirtualMachineStatus) {
	*out = *in
	...
	if in.Instance != nil {
		...
		*out = new(v1.VirtualMachineInstance)
		(*in).DeepCopyInto(*out)
	}
	if in.RootDiskVolume != nil {
		in, out := &in.RootDiskVolume, &out.RootDiskVolume
		*out = new(v1beta1.DataVolume)
		(*in).DeepCopyInto(*out)
	}
	if in.DataDiskVolumes != nil {
		in, out := &in.DataDiskVolumes, &out.DataDiskVolumes
