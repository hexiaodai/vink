...
import (
	v1alpha1 "github.com/kubevm.io/vink/pkg/k8s/client/clientset/versioned/typed/vink/v1alpha1"
	rest "k8s.io/client-go/rest"
	testing "k8s.io/client-go/testing"
)

type FakeVinkV1alpha1 struct {
	*testing.Fake
}
...
func (c *FakeVinkV1alpha1) RESTClient() rest.Interface {
