...
type TemplateInstanceInformer interface {
	...
	Lister() v1alpha1.TemplateInstanceLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.VinkV1alpha1().TemplateInstances(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.VinkV1alpha1().TemplateInstances(namespace).Watch(context.TODO(), options)
			},
		},
		&vinkv1alpha1.TemplateInstance{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *templateInstanceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&vinkv1alpha1.TemplateInstance{}, f.defaultInformer)
}

func (f *templateInstanceInformer) Lister() v1alpha1.TemplateInstanceLister {
	return v1alpha1.NewTemplateInstanceLister(f.Informer().GetIndexer())
}
