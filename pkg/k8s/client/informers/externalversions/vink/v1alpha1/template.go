	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.VinkV1alpha1().Templates(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.VinkV1alpha1().Templates(namespace).Watch(context.TODO(), options)
			},
		},
		&vinkv1alpha1.Template{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *templateInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&vinkv1alpha1.Template{}, f.defaultInformer)
}
